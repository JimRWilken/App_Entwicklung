...
export async function updateAvatar(avatarUri, currentuser) {
  try {
    
    // 1. Überprüfen, ob eine Datei vorhanden ist
    if (!avatarUri) throw new Error("Kein Profilbild zur Verfügung gestellt.");
