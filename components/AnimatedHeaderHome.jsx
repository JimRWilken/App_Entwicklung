...
const AnimatedHeaderHome = ({ animatedValue }) => {
  ...
  return (
    ...
    >
      <View style={styles.titleContainer}>
        <Text style={styles.headerText}>Startseite</Text>
      </View>
    </Animated.View>
  );
};
...
export default AnimatedHeaderHome; // Stelle sicher, dass es als Default exportiert wird
