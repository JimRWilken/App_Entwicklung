...
const AnimatedHeaderProfil = ({ animatedValue }) => {
  ...
  return (
    ...
    >
      <View style={styles.titleContainer}>
        <Text style={styles.headerText}>Lebensmittel scannen</Text>
...
export default AnimatedHeaderProfil; // Stelle sicher, dass es als Default exportiert wird
