...
const AnimatedHeaderErstellen = ({ animatedValue }) => {
  ...
  return (
    ...
    >
      <View style={styles.titleContainer}>
        <Text style={styles.headerText}>Rezept erstellen</Text>
...
export default AnimatedHeaderErstellen; // Stelle sicher, dass es als Default exportiert wird
